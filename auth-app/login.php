...
// Example credentials (aap database se bhi check kar sakte ho)
$valid_users = [
    'vishal' => 'password123',
    'rahul' => 'mypassword'];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows === 1) {
        ...
        if (password_verify($password, $user['password'])) {
            // Set session variables, including user_id for problemlist.php check
...
<body>
    <h1 class="welcome">Welcome to CodeArena</h1>
